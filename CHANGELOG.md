...
- Updated `@choiceopen/atomemo-plugin-schema` from ^0.6.4 to ^0.6.5

## [0.6.4] - 2026-03-24

### Changed

- Updated `@choiceopen/atomemo-plugin-schema` from ^0.6.1 to ^0.6.4

## [0.6.3] - 2026-03-24

### Changed

- Updated `@choiceopen/atomemo-plugin-schema` from ^0.6.0 to ^0.6.1
...
[Unreleased]: https://github.com/choice-open/atomemo-plugin-sdk-js/compare/v0.6.5...HEAD
...
[0.6.3]: https://github.com/choice-open/atomemo-plugin-sdk-js/compare/v0.6.2...v0.6.3
[0.6.2]: https://github.com/choice-open/atomemo-plugin-sdk-js/compare/v0.6.1...v0.6.2
